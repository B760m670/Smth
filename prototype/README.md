...
- **Аккаунты, персистентность, зоны, звук, анимация персонажа.** Капсула
  показывает направление конусом и ложится набок, когда умирает. Этого хватает,
  чтобы читать неткод.
