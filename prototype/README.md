...
собирает клиент и публикует на GitHub Pages. Включить Pages один раз в настройках
репозитория (Settings → Pages → Source: GitHub Actions) — это делается с телефона,
— и дальше открывается ссылка, и всё работает против ботов.
